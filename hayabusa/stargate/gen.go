...
//go:generate solc @openzeppelin/contracts-upgradeable=contracts/openzeppelin-upgradeable @openzeppelin/contracts=contracts/openzeppelin/  --evm-version paris --overwrite --optimize --via-ir --optimize-runs 200 -o ./ --abi --bin contracts/StargateDelegation.sol stargate.sol
